...
GAMEPLAY-TEST.
	...
	ELSE
		...
		*> Normal game 
		IF LK-DieTotal = 7 AND LK-COMEPOINTER = 0 AND LK-DONTCOMEPOINTER = 0 OR LK-DieTotal = 11 AND LK-COMEPOINTER = 0 AND LK-DONTCOMEPOINTER = 0
		...
		IF LK-DieTotal = 2  AND LK-COMEPOINTER = 0 AND LK-DONTCOMEPOINTER = 0 OR LK-DieTotal = 3 OR LK-DieTotal = 12 AND LK-COMEPOINTER = 0 AND LK-DONTCOMEPOINTER = 0
