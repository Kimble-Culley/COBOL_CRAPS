...
01 COMEOUT-MENU BACKGROUND-COLOR 2 FOREGROUND-COLOR 7 HIGHLIGHT. 
    ...
    02 LINE 24 COL 4 VALUE "Press ENTER to Roll the dice or Q to quit".
...
01 SCORE-ENTER BACKGROUND-COLOR 2 FOREGROUND-COLOR 7 HIGHLIGHT.
    02 BLANK SCREEN.
    02 LINE 2 COL 4 VALUE "PLEASE ENTER NAME: ".
    02 LINE 2 COL 22 USING WS-NEW-NAME.
...
DISPLAY-MAIN-SCREEN.
    ...
    IF WS-COUNTER = 10
        ...
        IF WS-PLAYER-INPUT = SPACES
            DISPLAY SCORE-ENTER
            ACCEPT SCORE-ENTER
            CALL "SCORE-RECORDS" USING WS-NEW-NAME WS-NEW-TOTAL
            CALL "DISPLAY-TOP-SCORES"
            MOVE SPACES TO WS-NEW-NAME
            MOVE 0 TO WS-NEW-TOTAL
            MOVE SPACES TO WS-PLAYER-INPUT
            MOVE 'N' TO WS-MESSAGE
            MOVE 0 TO WS-DieTotal
            MOVE 0 TO WS-PASSPOINTER
            MOVE 0 TO WS-DONTPASSPOINTER
